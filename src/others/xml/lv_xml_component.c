...
static void process_param_element(lv_xml_parser_state_t * state, const char ** attrs, const char * name);
...
static void start_metadata_handler(void * user_data, const char * name, const char ** attrs)
{
    ...
    switch(state->section) {
        case LV_XML_PARSER_SECTION_PARAMS:
            process_param_element(state, attrs, name);
            break;
